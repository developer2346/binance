...
```shell
go get github.com/developer2346/go-binance/v2
```
...
```golang
import (
    "github.com/developer2346/go-binance/v2"
)
```
...
```go
import (
    "github.com/developer2346/go-binance/v2/futures"
)
...
```go
import (
    "github.com/developer2346/go-binance/v2/delivery"
)
